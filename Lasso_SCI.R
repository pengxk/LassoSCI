...
repl3<-c(2,3,4,5,6,7,10,12,13,17,18,19,21,22,24,26,29,30,34,35,36,39,40)#Non-Cancerous
repl4<-c(1,8,9,11,14,15,16,20,23,25,27,28,31,32,33,37,38,41,42,43)#Cancerous

#s<-srswor(14, 17)
#obs <- repl[s!=0]
#obs
#repl5<-setdiff(repl,obs)
#repl5
